...
<a href='<%= my_url('addons/social_sharing?p=standard') %>'>Choose a site and subscribe to the Social Sharing add-on <span class='icon-arrow'></span></a>
