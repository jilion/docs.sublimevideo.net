...
At the top-right of the Real-Time Statistics dashboard, the last video 100 plays for the last 60 minutes appear in real-time as your visitors play your videos. For each video, we show you the browser, operating system and country of the viewer, as well as on which site he's watching the video.
...
In the next section, you will see by default all video loads and plays for the last 24 hours and for all sites. You can change the time range to the last 30, 90 or 365 days and also choose to display video loads and plays that happen on your own site only or on external sites only (showing embedded videos' stats only).
...
h3(#browser-country-device-stats). "Browser, Country & Device Statistics":#browser-country-device-stats

Browser + OS, Country and Mobile / Desktop statistics show you what the most popular load-cases are for your videos within the currently selected time range.
