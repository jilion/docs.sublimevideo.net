...
*Methods*: "(c)@play@":/javascript-api/player#play "(c)@pause@":/javascript-api/player#pause "(c)@stop@":/javascript-api/player#stop "(c)@setSize@":/javascript-api/player#setSize "(c)@videoId@":/javascript-api/player#videoId "(c)@videoElement@":/javascript-api/player#videoElement "(c)@on@":/javascript-api/player#on

*Events*: "(c)@start@":/javascript-api/player#event-start "(c)@play@":/javascript-api/player#event-play "(c)@pause@":/javascript-api/player#event-pause "(c)@end@":/javascript-api/player#event-end "(c)@stop@":/javascript-api/player#event-stop
