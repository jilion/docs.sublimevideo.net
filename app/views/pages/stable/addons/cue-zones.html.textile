...
* <span class="param">@cuepoints@</span> (@Array@) - A list of numbers representing the cuepoints. Negative numbers will be computed starting from the end of the playback. For instance, -2 will be converted to (duration - 2).

* <span class="param">@callback@</span> (@Function@) - The function to call when a cuepoint is reached.

Register the list of cuepoints to the player. If a list with the same provided id already exists, it will be replaced by the new list.

*Callback parameters*

* <span class="param">@player@</span> (@Object@) - The player API object.
* <span class="param">@cuepoint@</span> (@Object@) - The cuepoint API object. This object has only two attributes:
    - @index@: The index of the cuepoint in the cuepoints list.
    - @time@: The actual time at which the cuepoint callback is called.
* <span class="param">@id@</span> (@String@) - The id of the cuepoints list. This parameter is passed only for a cuepoints list with an id.

**Example - registering cuepoints**

bc(language-javascript). player.cuepoints.add([1.3, 6, 9, -49.5], function(player, cuepoint) {
