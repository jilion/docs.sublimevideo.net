...
All these settings can be configured via your site's Player editor page on <%= link_to "MySublimeVideo", my_url('sites') %> but can also be overridden on per video basis with the settings described below.
