...
The settings described below can be set via the "Players" page on <%= link_to "MySublimeVideo", my_url('sites') %> but if you want to override a player default settings for a specific video, you can do it with the following "settings":/settings/usage.
