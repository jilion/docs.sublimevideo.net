h2. <%= title('Social Sharing add-on') %>
...
The Social Sharing add-on displays a sharing button in the upper right hand corner of the player which –once clicked– opens a pane with different sharing options/services of your choice:
...
<a href='<%= my_url('addons/social_sharing?p=standard') %>'>Subscribe to the Social Sharing add-on <span class='icon-arrow'></span></a>
...
*Allowed values:*
* @default@ – _(Default)_ Default sharing icon. <%= image_tag('addons/sharing/sharing_default_icon@2x.png', class: 'text_top', height: '16px', title: 'Default sharing icon') %>
* @alt@ – Alternative icon. <%= image_tag('addons/sharing/sharing_alt_icon@2x.png', class: 'text_top', height: '16px', title: 'Alternative sharing icon') %>
