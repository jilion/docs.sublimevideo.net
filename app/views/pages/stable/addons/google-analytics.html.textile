...
<a name='note-1'></a> ^1^ : Only available if you're subscribed to the "Social Sharing add-on":/addons/sharing.
<a name='note-2'></a> ^2^ : Only available if you're subscribed to the "Your Logo add-on":/addons/on-video-logo.
