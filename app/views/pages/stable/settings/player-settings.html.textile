...
Allows you to define a unique ID for your video. %(red)If the "auto embedding":/addons/embed#auto-embedding feature is enabled, you must set a unique ID for your videos.%
...
Allows you to define a title for your video. *Please note that @data-name@ and the generic @title@ attribute are also supported.*
...
<!-- data-name is also supported -->
<video class='sublime' data-name='My awesome video'>
  ...
</video>
<!-- as well as the generic title attribute -->
