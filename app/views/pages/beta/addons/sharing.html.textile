...
Defines the main text to be shared (Used for Facebook, Twtter and Pinterest). If your message is longer than 140 character, remember to provide shorter and specific version for Twitter via the "sharing-twitter-text":#sharing-twitter-text setting. If you omit this setting, Facebook will extract this info from the @og:description@ metadata.
