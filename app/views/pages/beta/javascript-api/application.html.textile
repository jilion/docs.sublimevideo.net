...
See also "Using the JavaScript API":/beta/javascript-api/usage, "Player API":/beta/javascript-api/player and "Lightbox API":/beta/javascript-api/lightbox.
...
* <span class="param">@callback@</span> (@Function@) - The function to call once the element is prepared. Depending on the element you are preparing, the callback receives a "(c)@player@":/beta/javascript-api/player or "(c)@lightbox@":/beta/javascript-api/lightbox as parameter.
...
See also the "(c)@player API@":/beta/javascript-api/player and the "(c)@lightbox API@":/beta/javascript-api/lightbox.
...
See the "(c)@player API@":/beta/javascript-api/player for more information.
...
See the "(c)@lightbox API@":/beta/javascript-api/lightbox for more information.
