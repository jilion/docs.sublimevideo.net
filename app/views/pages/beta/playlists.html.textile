...
If you designed your site to be responsive/fluid and want to add a playlist, you will have to start by adding the "autoresize":/beta/responsive-layout attribute to your @<video>@ elements, and update the playlist's CSS to get the design you want.
